...
#ifndef XML_UTILITY_COMMON_H
#define XML_UTILITY_COMMON_H
...
{ 
  ...
  bool isNodePresent(rapidxml::xml_node<>* xmlNode, const std::string& errMsg, bool isWarning = false);
  bool isNodePresent(rapidxml::xml_node<>* xmlNode, int camNum, const std::string& errMsg, bool isWarning = false);

  bool isAttrPresent(rapidxml::xml_node<>* parentNode, const std::string& attrName);
  bool isAttrPresent(rapidxml::xml_node<>* parentNode, const std::string& attrName, const std::string& errorMsg, bool isWarning = false);
  ...
  rapidxml::xml_node<>* appendNewNode(rapidxml::xml_document<>* doc, rapidxml::xml_node<>* parentNode, const std::string& nodeName);


  rapidxml::xml_attribute<>* appendNewAttribute(rapidxml::xml_document<>* doc, rapidxml::xml_node<>* node, const std::string& attrName, const std::string& attrValue);
 
  rapidxml::xml_attribute<>* appendNewAttribute(rapidxml::xml_document<>* doc, rapidxml::xml_node<>* node, const std::string& attrName, float attrValue, const char *fmt = nullptr);
}
